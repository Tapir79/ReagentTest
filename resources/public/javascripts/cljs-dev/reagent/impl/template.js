...
var G__5722 = o;
(G__5722[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
var G__5724__i = 0, G__5724__a = new Array(arguments.length -  0);
while (G__5724__i < G__5724__a.length) {G__5724__a[G__5724__i] = arguments[G__5724__i + 0]; ++G__5724__i;}
  args = new cljs.core.IndexedSeq(G__5724__a,0);
} 
return G__5723__delegate.call(this,args);};
G__5723.cljs$lang$maxFixedArity = 0;
G__5723.cljs$lang$applyTo = (function (arglist__5725){
var args = cljs.core.seq(arglist__5725);
return G__5723__delegate(args);
});
...
var old_5726 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_5726))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_5726)].join(''):class$));
} else {
}
...
var G__5729 = jsprops;
(G__5729["defaultValue"] = value);

(G__5729["onChange"] = ((function (G__5729,v,value,on_change){
return (function (p1__5727_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__5727_SHARP_);
});})(G__5729,v,value,on_change))
);
...
var vec__5731 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__5731,(0),null);
var id = cljs.core.nth.call(null,vec__5731,(1),null);
var class$ = cljs.core.nth.call(null,vec__5731,(2),null);
...
var temp__4659__auto__ = (function (){var G__5733 = cljs.core.meta.call(null,v);
if((G__5733 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__5733);
}
})();
if((temp__4659__auto__ == null)){
...
var jsprops = {"argv": v};
var G__5735_5736 = v;
var G__5735_5737__$1 = (((G__5735_5736 == null))?null:reagent.impl.template.key_from_vec.call(null,G__5735_5736));
if((G__5735_5737__$1 == null)){
} else {
(jsprops["key"] = G__5735_5737__$1);
}
...
var p = (function (){var temp__4659__auto__ = (function (){var G__5740 = cljs.core.meta.call(null,argv);
if((G__5740 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__5740);
}
})();
if((temp__4659__auto__ == null)){
return jsprops;
...
var G__5741 = (((jsprops == null))?{}:jsprops);
(G__5741["key"] = key);
...
var n__5207__auto___5742 = a.length;
var i_5743 = (0);
while(true){
if((i_5743 < n__5207__auto___5742)){
(a[i_5743] = reagent.impl.template.as_element.call(null,(a[i_5743])));
...
var a = cljs.core.into_array.call(null,s);
var n__5207__auto___5745 = a.length;
var i_5746 = (0);
while(true){
if((i_5746 < n__5207__auto___5745)){
var val_5747 = (a[i_5746]);
if((cljs.core.vector_QMARK_.call(null,val_5747)) && ((reagent.impl.template.key_from_vec.call(null,val_5747) == null))){
(o["no-key"] = true);
} else {
}

(a[i_5746] = reagent.impl.template.as_element.call(null,val_5747));
...
var G__5750 = (cljs.core.count.call(null,argv) - first_child);
switch (G__5750) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__5750){
